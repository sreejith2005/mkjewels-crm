...
export default async function NewVisitPage({ searchParams }: { searchParams: Promise<{ queue?: string; client?: string }> }) {
  ...
  const selectedClientId = queueResult.data?.client_id ?? params.client ?? null;
